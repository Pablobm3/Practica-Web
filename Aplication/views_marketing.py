...
def alta_socio(request):
    if request.method == 'POST':
        ...
        # Verifica si ya existe un socio con el mismo DNI_Socio
        try:
            existe_socio = Socios.objects.get(DNI_Socio=DNI_Socio)
            # Si ya existe, muestra un mensaje de error o realiza la acción deseada
            return render(request, 'Aplication/Marketing/alta_socio.html', {'error_message': '¡Ya existe un socio con el mismo DNI!'})
            ...
            return render(request, 'Aplication/marketing.html', {'success_message': '¡Socio registrado correctamente!'})
...
def baja_socio(request):
    if request.method == 'POST':
        ...
        return render(request, 'Aplication/marketing.html', {'success_message': '¡Socio eliminado correctamente!'})
...
def modifica_socio(request):
    if request.method == 'POST':
        ...
        return render(request, 'Aplication/marketing.html', {'success_message': '¡Socio modificado correctamente!'})
...
def alta_campana(request):
    if request.method == 'POST':
        ...
        # Verifica si ya existe una campaña con el mismo ID_Campana
        try:
            existe_campana = Campanas.objects.get(ID_Campana=ID_Campana)
            # Si ya existe, muestra un mensaje de error o realiza la acción deseada
            return render(request, 'Aplication/Marketing/alta_campana.html', {'error_message': '¡Ya existe una campaña con el mismo ID!'})
            ...
            # Redirecciona a alguna vista o página después de la inserción (puedes cambiar 'home' a la URL deseada)
            return render(request, 'Aplication/marketing.html', {'success_message': '¡Campaña registrada correctamente!'})
...
def baja_campana(request):
    if request.method == 'POST':
        ...
        # Redirecciona a alguna vista o página después de la eliminación (puedes cambiar 'home' a la URL deseada)
        return render(request, 'Aplication/marketing.html', {'success_message': '¡Campaña eliminada correctamente!'})
...
def modifica_campana(request):
    if request.method == 'POST':
        ...
        return render(request, 'Aplication/marketing.html', {'success_message': '¡Campaña modificada correctamente!'})
